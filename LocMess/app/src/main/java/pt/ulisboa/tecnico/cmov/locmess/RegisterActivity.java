 ...
 * TODO
 *  - Lançar error quando não se tem internet
 *
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPasswordConfirmationView.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if(id == R.id.login || id == EditorInfo.IME_NULL || mPasswordConfirmationView.getText().toString().equals(mPasswordView.getText().toString())){
                    attemptRegister();
                    return true;
                }
                mPasswordView.setError(getString(R.string.error_password_equals));
                return false;
            }
        });
