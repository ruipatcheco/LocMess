        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_READ:
                    ...
                    try {
                        ois = new ObjectInputStream(new ByteArrayInputStream(readBuf));
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    ...
                    for (Profile profile : profiles) {
                        //Log.d("", "InputStream: " + profile.getKey() + "->" + profile.getValue());
                        readMessage += profile.getKey() + "->" + profile.getValue() + "; ";
                    }
